...
class RSSEntryFields(GraphNode):
    ...
    entry: types.RSSEntry | GraphNode | tuple[GraphNode, str] = Field(default=types.RSSEntry(type='rss_entry', title='', link='', published=Datetime(type='datetime', year=0, month=0, day=0, hour=0, minute=0, second=0, microsecond=0, tzinfo='UTC', utc_offset=0), summary='', author=''), description='The RSS entry to extract fields from.')
